...
pub struct MedcelDownloader;

impl Default for MedcelDownloader {
    fn default() -> Self {
        Self::new()
    }
}

impl MedcelDownloader {
    pub fn new() -> Self {
        Self
    }
}
...
#[async_trait]
impl PlatformDownloader for MedcelDownloader {
    fn name(&self) -> &str {
        "medcel"
    }
    ...
    fn can_handle(&self, url: &str) -> bool {
        if let Ok(parsed) = url::Url::parse(url) {
            if let Some(host) = parsed.host_str() {
                ...
                return host == "medcel.com.br"
                    || host == "areaaluno.medcel.com.br"
                    || host == "service.medcel.com.br";
            }
        }
        false
    }
